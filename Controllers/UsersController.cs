...
namespace CertificatesManager.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(CertificatesManagerDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,PhoneExtension,IsAdmin")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
					TempData["Msg"] = user.Name + " sucessfully updated";
				}
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
			TempData["Msg"] = user.Name + " sucessfully removed";
			return RedirectToAction(nameof(Index));
        }
