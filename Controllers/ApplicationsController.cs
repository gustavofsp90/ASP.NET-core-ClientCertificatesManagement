...
namespace CertificatesManager.Controllers
{
    public class ApplicationsController : Controller
    {
        ...
        public ApplicationsController(CertificatesManagerDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Application application)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
					...
					TempData["Msg"] = application.Name + " sucessfully updated.";
					await _context.SaveChangesAsync();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
			TempData["Msg"] = application.Name + " sucessfully removed.";
			return RedirectToAction(nameof(Index));
        }
