...
namespace CertificatesManager.Migrations
{
    ...
    [Migration("20191218144224_UpdateCertificateDetailServerSystem")]
    partial class UpdateCertificateDetailServerSystem
    {
            ...
            modelBuilder.Entity("CertificatesManager.Models.CertificateDetailSystem", b =>
                {
                    ...
                    b.HasOne("CertificatesManager.Models.Server", "System")
                        .WithMany()
